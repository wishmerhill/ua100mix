...
#
# Created: Sat Jul 26 21:09:27 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MasterLine.setGeometry(QtCore.QRect(790, 120, 23, 301))
        ...
        self.MasterLineLcd.setGeometry(QtCore.QRect(770, 490, 64, 23))
        self.MasterLineLcd.setObjectName(_fromUtf8("MasterLineLcd"))
        self.masterLabel = QtGui.QLabel(self.centralwidget)
        self.masterLabel.setGeometry(QtCore.QRect(750, 450, 111, 21))
        ...
        self.wave1Label.setGeometry(QtCore.QRect(320, 440, 111, 21))
        ...
        self.Wave1.setGeometry(QtCore.QRect(360, 120, 23, 301))
        ...
        self.Wave1Lcd.setGeometry(QtCore.QRect(340, 490, 64, 23))
        self.Wave1Lcd.setObjectName(_fromUtf8("Wave1Lcd"))
        self.Mic1 = QtGui.QSlider(self.centralwidget)
        self.Mic1.setGeometry(QtCore.QRect(140, 120, 23, 301))
        ...
        self.Mic1Lcd.setGeometry(QtCore.QRect(120, 490, 64, 23))
        self.Mic1Lcd.setObjectName(_fromUtf8("Mic1Lcd"))
        self.mic1Label = QtGui.QLabel(self.centralwidget)
        self.mic1Label.setGeometry(QtCore.QRect(100, 440, 111, 21))
        ...
        self.Mic1Pan.setGeometry(QtCore.QRect(130, 50, 50, 64))
        ...
        self.Mic2.setGeometry(QtCore.QRect(250, 120, 23, 301))
        ...
        self.Mic2Lcd.setGeometry(QtCore.QRect(230, 490, 64, 23))
        self.Mic2Lcd.setObjectName(_fromUtf8("Mic2Lcd"))
        self.mic2Label = QtGui.QLabel(self.centralwidget)
        self.mic2Label.setGeometry(QtCore.QRect(210, 440, 111, 21))
        ...
        self.Mic2PanLcd.setGeometry(QtCore.QRect(230, 30, 64, 23))
        self.Mic2PanLcd.setObjectName(_fromUtf8("Mic2PanLcd"))
        self.Wave2 = QtGui.QSlider(self.centralwidget)
        self.Wave2.setGeometry(QtCore.QRect(470, 120, 23, 301))
        ...
        self.Wave2Lcd.setGeometry(QtCore.QRect(450, 490, 64, 23))
        self.Wave2Lcd.setObjectName(_fromUtf8("Wave2Lcd"))
        self.wave1Label_2 = QtGui.QLabel(self.centralwidget)
        self.wave1Label_2.setGeometry(QtCore.QRect(430, 440, 111, 21))
